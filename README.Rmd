...
![Figure 1: Temperature sinusoid](SSTcurve.png)
![Figure 2: Growth rate sinusoid](GRcurve.png)
...
![Figure 3: Timing of whole model run at various data resolutions](Timing.png)
