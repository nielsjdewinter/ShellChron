...
**NOTE**: To run optimally, ShellChron requires sampling distance data to be provided in micrometers (see "data_import()" function). The optimal structure of the input CSV should be as follows (see slao in "Virtual_shell" example):
