...
#' testarray2 <- suppressWarnings(CumDY2(testarray, FALSE, FALSE)) # Apply function on array
#' @export
CumDY2 <- function(resultarray, # Align Day of year results from modelling in different windows to a common time axis
