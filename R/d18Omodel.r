...
#' 
#' @param SST Matrix with a time column (values in days) and an SST column (values
#' in degrees C)
...
#' d18O <- d18Omodel(SST, 0, "calcite")
#' @export
d18Omodel <- function(SST, # Function that converts SST values into d18O 
    ...
    mineral = "calcite" # Using either Kim and O'Neil (calcite calibration; 1997) or Grossman and Ku (aragonite calibration; 1986) 
    ){
