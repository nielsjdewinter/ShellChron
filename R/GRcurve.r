...
#' @return A matrix containing columns for time (in days) and GR (in micrometer/day)
#' @examples
#' # Set parameters
#' G_amp <- 20
#' G_per <- 365
...
#' GR <- GRcurve(G_par, 1, 1)
#' @export
GRcurve <- function(G_par, # Function to create growth rate as function of time based on parameters
